...
$page_content = $page->get_page('subscribe');
?>
<!DOCTYPE html>
<!--[if IE 8]>
...
<title>Edit 'Subscribe' Page</title>
...
<div id="titlediv">
<div id="titlewrap">
	<input type="text" name="title" size="30" id="title" autocomplete="off" placeholder='Subject' value='Subscribe' readonly />
