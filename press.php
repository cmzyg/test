...
<div class="wrap">
<h2>
<?php echo $page_label; ?> <a href="<?php echo $admin_url; ?>add-press" class="add-new-h2">New Press</a>
</h2>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col' class='manage-column'><a href=""><span>Name</span></a></th>
	...
	<tr id='user-1' class="alternate"><th scope='row' class='check-column'><label class="screen-reader-text" for="cb-select-1">Select Admin</label></th>
		<td><strong><?php echo $row['brand_name']; ?></strong><br /><div class="row-actions"><span class='edit'><a href="<?php echo $admin_url; ?>edit-press/<?php echo $row['brand_id']; ?>">Edit</a> | </span><span class='delete'><a class='submitdelete' href='<?php echo $admin_url; ?>delete-press/<?php echo $row['brand_id']; ?>'>Delete</a></span></div></td>
    <td><?php echo $general->limit_words($row['brand_description'], 30); ?></td>
  </tr>

    <?php
    }
    echo '<div style="float: right">' . $count . ' press&nbsp;&nbsp;&nbsp;<br />';
