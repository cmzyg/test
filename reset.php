...
<!DOCTYPE html>
	...
	<div id="login">
		<h3 style="text-align:center">Please set up a new password</h3>
		<h3><?php echo $controller->flashdata('Repeat_Error'); ?></h3>
	
<form name="loginform" id="loginform" action="../process-reset" method="post">
	<p>
		<label for="user_pass">New Password<br />
		<input type="password" name="user_pass" id="user_pass" class="input" value="" size="20" /></label>
	</p>

	<p>
		<label for="user_pass">Repeat New Password<br />
		<input type="password" name="repeat_user_pass" id="user_pass" class="input" value="" size="20" /></label>
	</p>

	<input type="hidden" name="token" value="<?php echo $_GET['token']; ?>" />
		
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Reset" />
	</p>
</form>
