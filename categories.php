...
<div class="wrap">
<h2>
Categories <a href="../add-category" class="add-new-h2">New Category</a>
</h2>

<?php echo $session->flashdata('category-added'); ?>
<?php echo $session->flashdata('category-deleted'); ?>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr id='user-1' class="alternate"><th scope='row' class='check-column'><label class="screen-reader-text" for="cb-select-1">Select Admin</label></th>
		<td><strong><?php echo $row['category']; ?></strong><br /><div class="row-actions"><span class='edit'><a href="../edit-category/<?php echo $row['id']; ?>">Edit</a> | </span><span class='delete'><a class='submitdelete' href='../delete-category/<?php echo $row['id']; ?>'>Delete</a></span></div></td>
	</tr>
