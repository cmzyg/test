...
$posts_array = $posts->get_all_posts();
...
<div class="wrap">
<h2>
Posts <a href="../add-post" class="add-new-h2">New Post</a>
</h2>

<?php echo $session->flashdata('post-added'); ?>
<?php echo $session->flashdata('post-deleted'); ?>
<?php echo $session->flashdata('post-saved'); ?>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col' id='username' class='manage-column column-username sortable desc'><a href=""><span>Post Title</span></a></th>
		<th scope='col' id='email' class='manage-column column-email sortable desc'><a href=""><span>Category</span></a></th>
		<th scope='col' id='name' class='manage-column column-name sortable desc'><a href=""><span>Date</span></a></th>
	</tr>
	</thead>
	...
	<tr>
		...
		<th scope='col' class='manage-column column-username'><a href=""><span>Post Title</span></a></th>
		<th scope='col' class='manage-column column-email'><a href=""><span>Category</span></a></th>
		<th scope='col' class='manage-column column-name sortable desc'><a href=""><span>Date</span></a></th>
    </tr>
	</tfoot>
	...
	<?php
       ...
       if (count($posts_array)) {
          ...
          $pagination = new pagination($posts_array, (isset($_GET['page']) ? $_GET['page'] : 1), 10, 'posts');
	...
	<tr id='user-1' class="alternate"><th scope='row' class='check-column'><label class="screen-reader-text" for="cb-select-1">Select Admin</label></th>
		<td><strong><?php echo $row['post_title']; ?></strong><br /><div class="row-actions"><span class='edit'><a href="../edit-post/<?php echo $row['post_id']; ?>">Edit</a> | </span><span class='delete'><a class='submitdelete' href='../delete-post/<?php echo $row['post_id']; ?>'>Delete</a></span></div></td>
		<td><?php echo $row['post_category']; ?></td>
		<td><?php echo date('d-m-Y H:i:s', strtotime($row['date_published'])); ?></td>
	</tr>

    <?php
    }
    echo '<div style="float: right">' . $count . ' posts&nbsp;&nbsp;&nbsp;<br />';
