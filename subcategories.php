...
$categories_array = $categories->get_all_subcategories();
$count = 1;
...
<div class="wrap">
<h2>
Sub Categories <a href="new-sub-category" class="add-new-h2">New Sub Category</a>
</h2>

<?php echo $session->flashdata('subcategory-added'); ?>
<?php echo $session->flashdata('subcategory-deleted'); ?>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col' class='manage-column column-username'><a href=""><span>Sub Category Name</span></a></th>
    </tr>
	</tfoot>
	...
	<?php
       ...
       if (count($categories_array)) {
          ...
          $pagination = new pagination($categories_array, (isset($_GET['page']) ? $_GET['page'] : 1), 10, 'posts');
	...
	?>
	<tr id='user-1' class="alternate"><th scope='row' class='check-column'><label class="screen-reader-text" for="cb-select-1">Select Admin</label><input type='checkbox' name='posts[]' id='user_1' class='administrator' value='1' /></th>
		<td><strong><?php echo $row['category']; ?></strong><br /><div class="row-actions"><span class='edit'><a href="../edit-sub-category/<?php echo $row['id']; ?>">Edit</a> | </span><span class='delete'><a class='submitdelete' href='../delete-sub-category/<?php echo $row['id']; ?>'>Delete</a></span></div></td>
	</tr>

    <?php
    }
    echo '<div style="float: right">' . $count . ' sub categories&nbsp;&nbsp;&nbsp;<br />';
