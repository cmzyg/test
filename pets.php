...
require_once('core/pets.class.php');
...
$pets_array = $pets->get_all_pets();
$count      = $pets->count_pets();
...
<div class="wrap">
<h2>
Pets <a href="../add-pet" class="add-new-h2">Add New Pet</a>
</h2>

<?php echo $session->flashdata('pet-deleted'); ?>
<?php echo $session->flashdata('pet-inserted'); ?>
...
<table class="wp-list-table widefat fixed users" cellspacing="0">
	...
	<tr>
		...
		<th scope='col' id='name' class='manage-column column-name sortable desc'><a href=""><span>Description</span></a></th>
	</tr>
	</thead>
	...
	<tr>
		...
		<th scope='col' class='manage-column column-name sortable desc'><a href=""><span>Description</span></a></th>
    </tr>
	</tfoot>
	...
	<?php
       ...
       if (count($pets_array)) {
          ...
          $pagination = new pagination($pets_array, (isset($_GET['page']) ? $_GET['page'] : 1), 20, 'pets');
	...
	<tr id='user-1' class="alternate"><th scope='row' class='check-column'><label class="screen-reader-text" for="cb-select-1">Select Admin</label></th>
		<td><strong><?php echo $row['pet_id']; ?></strong><br /><div class="row-actions"><span class='edit'><a href="../edit-pet/<?php echo $row['pet_id']; ?>">Edit</a> | <span class='delete'><a class='submitdelete' href='../delete-pet/<?php echo $row['pet_id']; ?>'>Delete</a></span></div></td>
		<td><?php echo $row['pet_name']; ?></td>
		<td><?php echo $general->limit_words($row['pet_description'], 5); ?></td>
	</tr>

    <?php
    }
    echo '<div style="float: right">' . $count . ' pets&nbsp;&nbsp;&nbsp;<br />';
